...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewEntertainment = view.findViewById(R.id.recyclerentertainment);
        recyclerViewEntertainment.setLayoutManager(new LinearLayoutManager(getActivity()));
        newsModelArrayList = new ArrayList<>();

        adapter = new Adapter(getContext(),newsModelArrayList);
        recyclerViewEntertainment.setAdapter(adapter);
        makeCall("entertainment");
